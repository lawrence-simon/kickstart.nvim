    ...
    java = {
      ...
      configuration = {
        runtimes = {
          {
            name = 'JavaSE-21',
            path = home .. '/.jenv/versions/temurin64-21.0.4',
          },
          {
            name = 'JavaSE-17',
            path = home .. '/.jenv/versions/corretto64-17.0.6',
          },
          {
            name = 'JavaSE-11',
            path = home .. '/.jenv/versions/temurin64-11.0.22',
          },
          {
            name = 'JavaSE-1.8',
            path = home .. '/.jenv/versions/corretto64-1.8.0.422',
          },
        },
      },
    },
